...
# we want it.
os.system(f"from_glibc/utf8_gen.py --unicode_version {unicode_version}")
processing = False
    ...
    if processing:
        if line == "END WIDTH\n":
            ...
            try:
                ...
                print(e, f"warning: ignored unexpected line: {line}", file=sys.stderr, end="")
    elif line == "WIDTH\n":
        processing = True
...
print(
    f"    utf8_gen.py, using version {unicode_version}",
